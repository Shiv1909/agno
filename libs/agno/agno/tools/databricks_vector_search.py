...
class DatabricksVectorSearchTools(Toolkit):
    ...
    def list_endpoints(self, limit: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"Error listing Databricks vector search endpoints: {e}"
    ...
    def create_endpoint(
        ...
        try:
            ...
            return f"Error creating Databricks vector search endpoint: {e}"
    ...
    def create_delta_sync_index(
        ...
        try:
            ...
            return f"Error creating Databricks delta sync vector search index: {e}"
    ...
    def create_direct_access_index(
        ...
        try:
            ...
            return f"Error creating Databricks direct access vector search index: {e}"
    ...
    def list_indexes(self, endpoint_name: Optional[str] = None, limit: Optional[int] = None) -> str:
        ...
        try:
            ...
            return f"Error listing Databricks vector search indexes: {e}"
    ...
    def describe_index(self, index_name: Optional[str] = None, endpoint_name: Optional[str] = None) -> str:
        ...
        try:
            ...
            return f"Error describing Databricks vector search index: {e}"
    ...
    def query_index(
        ...
        try:
            ...
            return f"Error querying Databricks vector search index: {e}"
    ...
    def sync_index(self, index_name: Optional[str] = None, endpoint_name: Optional[str] = None) -> str:
        ...
        try:
            ...
            return f"Error syncing Databricks vector search index: {e}"
    ...
    def upsert_vectors(
        ...
        try:
            ...
            return f"Error upserting Databricks vector search vectors: {e}"
    ...
    def delete_vectors(
        ...
        try:
            ...
            return f"Error deleting Databricks vector search vectors: {e}"
